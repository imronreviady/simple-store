...
import com.imronreviady.simplestore.databinding.FragmentRatingListBinding;
import com.imronreviady.simplestore.databinding.ItemRatingEntryBinding;
...
import com.imronreviady.simplestore.ui.rating.adapter.RatingListAdapter;
...
public class RatingListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
        ...
        if (item.getItemId() == R.id.edit_rating) {
            ...
            if (loginUserId.isEmpty()) {
                ...
                psDialogMsg.okButton.setOnClickListener(v1 -> {
                    psDialogMsg.cancel();
                    navigationController.navigateToUserLoginActivity(RatingListFragment.this.getActivity());
                });
    ...
    protected void initUIAndActions() {
        ...
        binding.get().writeReviewButton.setOnClickListener(v -> {
