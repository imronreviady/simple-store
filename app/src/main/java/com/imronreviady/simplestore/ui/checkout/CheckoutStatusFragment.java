...
import com.imronreviady.simplestore.databinding.CheckoutFragmentStatusBinding;
...
public class CheckoutStatusFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
        ...
        if (getActivity() != null) {
            ...
            if (!overAllTax.equals(Constants.ZERO)) {

                binding.get().textView22.setText(getString(R.string.tax, overAllTax));
            }

            if (!shippingTax.equals(Constants.ZERO)) {

                binding.get().textView24.setText(getString(R.string.shipping_tax, shippingTax));
            }
        }
    }
