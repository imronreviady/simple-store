package com.imronreviady.simplestore.ui.notification.setting;
...
import com.imronreviady.simplestore.databinding.FragmentNotificationSettingBinding;
    ...
    private void updateNotificationSetting(Boolean setting) {
        ...
        if (getActivity() != null) {
            ...
            if (notificationViewModel.pushNotificationSetting != setting) {
                ...
                if (setting) {
                    notificationViewModel.registerNotification(getContext(), Constants.PLATFORM, "");

                } else {
                    notificationViewModel.unregisterNotification(getContext(), Constants.PLATFORM, "");
