...
import com.imronreviady.simplestore.databinding.FragmentSearchBinding;
...
public class SearchFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().categorySelectionView.setOnClickListener(view -> navigationController.navigateToSearchActivityCategoryFragment(SearchFragment.this.getActivity(), Constants.CATEGORY, catId, subCatId));
        ...
        binding.get().subCategorySelectionView.setOnClickListener(view -> {
            ...
            if (catId.equals(Constants.NO_DATA)) {
                ...
                navigationController.navigateToSearchActivityCategoryFragment(SearchFragment.this.getActivity(), Constants.SUBCATEGORY, catId, subCatId);
            }
        });
