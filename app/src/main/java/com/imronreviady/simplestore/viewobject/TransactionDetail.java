...
public class TransactionDetail {
    ...
    public TransactionDetail(@NonNull String id, String transactionsHeaderId, String productId,
                             String productAttributeId, String productAttributeName, float originalPrice,
                             float price, float discountAvailableAmount, String qty, String colorId, float discountValue,
                             float discountPercent, String addedDate, String addedUserId, String updatedDate, String updatedUserId,
                             String updatedFlag, String currencySymbol, String currencyShortForm, String addedDateStr, String updatedDateStr,
                             String productName, String productColorId, String productColorCode) {
        this.id = id;
